        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4 text-gray-400 hover:text-white transition">
              <a href="#" className="w-8 h-8 flex items-center justify-center rounded bg-gray-800 hover:bg-gray-700">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <a href="#" className="w-8 h-8 flex items-center justify-center rounded bg-gray-800 hover:bg-gray-700">
                ...
                >
                  <path
                    d="M22.675 0h-19.35c-1.49 0-2.7 1.21-2.7 2.7v18.6c0 1.49 1.21 2.7 2.7 2.7h19.35c1.49 0 2.7-1.21 2.7-2.7V2.7c0-1.49-1.21-2.7-2.7-2.7zm-10.575 21.575V11.005h-3.575v3.79h-2.26v-3.79h-3.55v5.385H8.95V11.005h-2.25v-2.37h2.25V6.55c0-1.875.97-3.05 2.88-3.05.95 0 1.665.055 1.95.1v2.205h-1.25c-.8 0-1.08.45-1.08 1.15v2.41h2.37v-1.56c0-.815.31-1.375.925-1.375.95 0 1.375.55 1.375 1.375V11h2.37v10.575h-2.37z"
                  />
                </svg>
              </a>
              <a href="#" className="w-8 h-8 flex items-center justify-center rounded bg-gray-800 hover:bg-gray-700">
                ...
                >
                  <path
                    d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm-1-6a3.5 3.5 0 100 7 3.5 3.5 0 000-7zm9 3.5H15v-2c0-1.105-.9-2-2-2s-2 .895-2 2v2H8v-.25c0-2.76 2.25-5 5-5s5 2.24 5 5v2z"
                  />
                </svg>
              </a>
            </div>
