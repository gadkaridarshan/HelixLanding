        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-custom hover:shadow-2xl transition-all hover-lift">
            ...
            <p className="text-gray-600 text-center">
              Helix analyzes your goals and requirements to determine the optimal
              approach and agent combination.
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-custom hover:shadow-2xl transition-all hover-lift">
            <div className="relative w-12 h-12 mb-4">
            ...
            <p className="text-gray-600 text-center">
              Specialized AI agents collaborate in parallel, sharing insights and
              dynamically adjusting their approach based on intermediate results.
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-custom hover:shadow-2xl transition-all hover-lift">
            <div className="relative w-12 h-12 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Result Synthesis</h3>
            <p className="text-gray-600 text-center">
              Individual agent outputs are intelligently combined into a cohesive,
              actionable insight tailored to your specific needs.
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-xl shadow-custom hover:shadow-2xl transition-all hover-lift">
            <div className="relative w-12 h-12 mb-4">
