        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              We analyze your intent and break down complex goals into
              manageable steps
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Our AI agents collaborate to execute each step with precision and
              efficiency
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Receive actionable insights and completed tasks ready for
              immediate use
            </p>
          </div>
          <div className="flex flex-col items-center text-center p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
            ...
            <p className="text-gray-600">
              Continuous feedback loop ensures results evolve with your changing
              needs
            </p>
          </div>
        </div>
