  ...
  render() {
    return (
      <Html>
        <Head>
          <title>
            Helix AI Orchestrator – Professional Marketing Landing Page
          </title>
          <meta
            name="description"
            content="Helix combines cutting-edge AI with intuitive workflow management to deliver unparalleled productivity and insight."
          />
